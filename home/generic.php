...
$_SESSION[ 'session_register_Token' ] = md5( uniqid() );
						...
						<div class="inner">
							...
							<div class="flex flex-2">
								<div class="col col2">
									...
									<form method="POST" action="http://www.jnsproduction.tw/register_info.php">

										Username*<input type="text" name="content_3" size="16"><br><br>
										Password*<input type="password" name="content_4" size="16"><br><br>
										Retry Password*<input type="password" name="content_5" size="16"><br><br>
										姓名*<input type="text" name="content_6" size="16"><br><br>
										綽號<input type="text" name="content_7" size="16"><br><br>
										電話*<input type="text" name="content_8" size="10"><br><br>
										信箱*<input type="text" name="content_9" size="10">
										<input type='hidden' name='user_token' value="<?php echo $_SESSION[ 'session_register_Token' ]; ?>" />
										<input type="submit" value="submit" name="button_1">
								</div>
